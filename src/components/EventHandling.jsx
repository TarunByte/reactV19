...
export const EventHandling = () => {
  ...
  return (
    <>
      ...
      {/* Remember how we havn't called this function, if you call this function here it will run without even clicking. You just need to pass reference and not call here. */}
      ...
      <button onClick={() => alert("Hey i am onClick Event")}>
        Inline Arr fun
      </button>
