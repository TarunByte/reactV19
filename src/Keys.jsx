...
export const Keys = () => {
  ...
  const handleFormSubmit = (event) => {
    ...
    // setTask can take either a new state value or a function. when it takes a function, React passes the current state (the previous state) as an argument to this function.
